...
def _parse_version_tuple(v: str) -> Optional[Tuple[int, ...]]:
    """
    @brief Execute function `_parse_version_tuple`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param v Input parameter for `_parse_version_tuple`.
    @return Optional[Tuple[int, ...]] Return value generated by `_parse_version_tuple`.
    """
    v = (v or "").strip()
    if not v:
        return None
...
def _is_version_newer(latest: str, current: str) -> bool:
    """
    @brief Execute function `_is_version_newer`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param latest Input parameter for `_is_version_newer`.
    @param current Input parameter for `_is_version_newer`.
    @return bool Return value generated by `_is_version_newer`.
    """
...
def _get_latest_version_from_github(owner: str, repo: str) -> Optional[str]:
    """
    @brief Execute function `_get_latest_version_from_github`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param owner Input parameter for `_get_latest_version_from_github`.
    @param repo Input parameter for `_get_latest_version_from_github`.
    @return Optional[str] Return value generated by `_get_latest_version_from_github`.
    """
...
def check_for_new_version(program: str, current_version: str) -> None:
    """
    @brief Execute function `check_for_new_version`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param program Input parameter for `check_for_new_version`.
    @param current_version Input parameter for `check_for_new_version`.
    @return None Return value generated by `check_for_new_version`.
    """
...
def safe_filename(path: str) -> str:
    """
    @brief Execute function `safe_filename`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param path Input parameter for `safe_filename`.
    @return str Return value generated by `safe_filename`.
    """
    path = (path or "").strip()
...
def positive_int(value: str) -> int:
    """
    @brief Execute function `positive_int`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param value Input parameter for `positive_int`.
    @return int Return value generated by `positive_int`.
    """
    try:
        parsed = int(value)
...
def is_http_url(s: str) -> bool:
    """
    @brief Execute function `is_http_url`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param s Input parameter for `is_http_url`.
    @return bool Return value generated by `is_http_url`.
    """
    try:
        u = urlparse(s)
...
def normalize_url(u: str, base: str) -> str:
    """
    @brief Execute function `normalize_url`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param u Input parameter for `normalize_url`.
    @param base Input parameter for `normalize_url`.
    @return str Return value generated by `normalize_url`.
    """
    u = (u or "").strip()
    if not u:
        return u
...
def ensure_parent(p: Path) -> None:
    """
    @brief Execute function `ensure_parent`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param p Input parameter for `ensure_parent`.
    @return None Return value generated by `ensure_parent`.
    """
...
def local_path_for_url(asset_url: str, out_dir: Path) -> Path:
    """
    @brief Execute function `local_path_for_url`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param asset_url Input parameter for `local_path_for_url`.
    @param out_dir Input parameter for `local_path_for_url`.
    @return Path Return value generated by `local_path_for_url`.
    """
...
def download_one(
    ...
    """
    @brief Execute function `download_one`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param session Input parameter for `download_one`.
    @param url Input parameter for `download_one`.
    @param dest Input parameter for `download_one`.
    @param timeout Input parameter for `download_one`.
    @return bool Return value generated by `download_one`.
    """
    ensure_parent(dest)
    try:
...
def escape_html(s: str) -> str:
    """
    @brief Execute function `escape_html`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param s Input parameter for `escape_html`.
    @return str Return value generated by `escape_html`.
    """
    return (
        s.replace("&", "&amp;")
        .replace("<", "&lt;")
...
class TocNode:
    """
    @brief Class `TocNode` runtime component.
...
def limit_toc_nodes(nodes: List[TocNode], max_entries: Optional[int]) -> List[TocNode]:
    """
    @brief Execute function `limit_toc_nodes`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param nodes Input parameter for `limit_toc_nodes`.
    @param max_entries Input parameter for `limit_toc_nodes`.
    @return List[TocNode] Return value generated by `limit_toc_nodes`.
    """
    ...
    def trim_list(items: List[TocNode]) -> List[TocNode]:
        """
        @brief Execute method `trim_list`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param items Input parameter for `trim_list`.
        @return List[TocNode] Return value generated by `trim_list`.
        """
        nonlocal count
        out: List[TocNode] = []
        for n in items:
...
def ensure_heading_ids(soup: BeautifulSoup) -> None:
    """
    @brief Execute function `ensure_heading_ids`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `ensure_heading_ids`.
    @return None Return value generated by `ensure_heading_ids`.
    """
    used: Set[str] = set()
...
def strip_styles(soup: BeautifulSoup) -> None:
    """
    @brief Execute function `strip_styles`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `strip_styles`.
    @return None Return value generated by `strip_styles`.
    """
...
def toc_from_headings(soup: BeautifulSoup) -> List[TocNode]:
    """
    @brief Execute function `toc_from_headings`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `toc_from_headings`.
    @return List[TocNode] Return value generated by `toc_from_headings`.
    """
    nodes: List[TocNode] = []
...
def toc_from_nav_html(toc_html: str, base_url: str) -> List[TocNode]:
    """
    @brief Execute function `toc_from_nav_html`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param toc_html Input parameter for `toc_from_nav_html`.
    @param base_url Input parameter for `toc_from_nav_html`.
    @return List[TocNode] Return value generated by `toc_from_nav_html`.
    """
    soup = BeautifulSoup(toc_html, "lxml")

    def parse_list(list_el) -> List[TocNode]:
        """
        @brief Execute method `parse_list`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param list_el Input parameter for `parse_list`.
        @return List[TocNode] Return value generated by `parse_list`.
        """
        items: List[TocNode] = []
...
def nav_outline_from_html(nav_html: str) -> str:
    """
    @brief Execute function `nav_outline_from_html`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param nav_html Input parameter for `nav_outline_from_html`.
    @return str Return value generated by `nav_outline_from_html`.
    """
    ...
    def norm_text(t: str) -> str:
        """
        @brief Execute method `norm_text`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param t Input parameter for `norm_text`.
        @return str Return value generated by `norm_text`.
        """
    ...
    def bullet(depth: int) -> str:
        """
        @brief Execute method `bullet`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param depth Input parameter for `bullet`.
        @return str Return value generated by `bullet`.
        """
        if depth == 0:
            return "*"
        if depth == 1:
    ...
    def walk_ul(ul, depth: int) -> None:
        """
        @brief Execute method `walk_ul`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param ul Input parameter for `walk_ul`.
        @param depth Input parameter for `walk_ul`.
        @return None Return value generated by `walk_ul`.
        """
...
class Logger:
    """
    @brief Class `Logger` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """

    def __init__(self, verbose: bool = False, debug: bool = False):
        """
        @brief Execute method `__init__`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `__init__`.
        @param verbose Input parameter for `__init__`.
        @param debug Input parameter for `__init__`.
        @return Any Return value generated by `__init__`.
        """
    ...
    def info(self, msg: str) -> None:
        """
        @brief Execute method `info`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `info`.
        @param msg Input parameter for `info`.
        @return None Return value generated by `info`.
        """
        print(msg)

    def verbose(self, msg: str) -> None:
        """
        @brief Execute method `verbose`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `verbose`.
        @param msg Input parameter for `verbose`.
        @return None Return value generated by `verbose`.
        """
    ...
    def debug(self, msg: str) -> None:
        """
        @brief Execute method `debug`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `debug`.
        @param msg Input parameter for `debug`.
        @return None Return value generated by `debug`.
        """
    ...
    def check(self, msg: str) -> None:
        """
        @brief Execute method `check`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `check`.
        @param msg Input parameter for `check`.
        @return None Return value generated by `check`.
        """
...
class UpgradeAction(argparse.Action):
    """
    @brief Class `UpgradeAction` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    def __call__(
        self,
        ...
        """
        @brief Execute method `__call__`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `__call__`.
        @param parser Input parameter for `__call__`.
        @param namespace Input parameter for `__call__`.
        @param values Input parameter for `__call__`.
        @param option_string Input parameter for `__call__`.
        @return None Return value generated by `__call__`.
        """
        try:
            proc = subprocess.run(
                [
...
class VersionedArgumentParser(argparse.ArgumentParser):
    """
    @brief Class `VersionedArgumentParser` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    ...
    def __init__(self, *args, version: str = "", **kwargs):
        ...
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `__init__`.
        @param version Input parameter for `__init__`.
        @param *args Input parameter for `__init__`.
        @param **kwargs Input parameter for `__init__`.
        @return Any Return value generated by `__init__`.
        """
    ...
    def format_usage(self) -> str:
        """
        @brief Execute method `format_usage`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `format_usage`.
        @return str Return value generated by `format_usage`.
        """
...
def iter_asset_urls(soup: BeautifulSoup, page_url: str) -> Set[str]:
    """
    @brief Execute function `iter_asset_urls`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `iter_asset_urls`.
    @param page_url Input parameter for `iter_asset_urls`.
    @return Set[str] Return value generated by `iter_asset_urls`.
    """
    urls: Set[str] = set()
...
def rewrite_asset_links_inplace(
    ...
    """
    @brief Execute function `rewrite_asset_links_inplace`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `rewrite_asset_links_inplace`.
    @param base_url Input parameter for `rewrite_asset_links_inplace`.
    @param out_dir Input parameter for `rewrite_asset_links_inplace`.
    @return None Return value generated by `rewrite_asset_links_inplace`.
    """
    def to_rel(u: str) -> str:
        """
        @brief Execute method `to_rel`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param u Input parameter for `to_rel`.
        @return str Return value generated by `to_rel`.
        """
    ...
    for t in soup.find_all(style=True):
        ...
        def repl(m):
            """
            @brief Execute method `repl`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param m Input parameter for `repl`.
            @return Any Return value generated by `repl`.
            """
            raw = m.group(1).strip().strip("'\"")
...
def normalize_document_links_inplace(soup: BeautifulSoup, logger: Optional[Logger]) -> None:
    """
    @brief Execute function `normalize_document_links_inplace`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param soup Input parameter for `normalize_document_links_inplace`.
    @param logger Input parameter for `normalize_document_links_inplace`.
    @return None Return value generated by `normalize_document_links_inplace`.
    """
...
def build_toc_html(
    ...
    """
    @brief Execute function `build_toc_html`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param toc_items Input parameter for `build_toc_html`.
    @param document_filename Input parameter for `build_toc_html`.
    @param target_frame Input parameter for `build_toc_html`.
    @return str Return value generated by `build_toc_html`.
    """
    def resolved_href(href: str) -> str:
        """
        @brief Execute method `resolved_href`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param href Input parameter for `resolved_href`.
        @return str Return value generated by `resolved_href`.
        """
        href = (href or "").strip()
    ...
    def render_nodes(nodes: List[TocNode]) -> str:
        """
        @brief Execute method `render_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `render_nodes`.
        @return str Return value generated by `render_nodes`.
        """
        if not nodes:
            return ""
        items = []
...
def build_frameset_index(
    ...
    """
    @brief Execute function `build_frameset_index`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param toc_filename Input parameter for `build_frameset_index`.
    @param document_filename Input parameter for `build_frameset_index`.
    @return str Return value generated by `build_frameset_index`.
    """
    return f"""<!doctype html>
<html lang="it">
<head>
...
def minimal_readable_wrapper(
    ...
    """
    @brief Execute function `minimal_readable_wrapper`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param inner_html Input parameter for `minimal_readable_wrapper`.
    @param title Input parameter for `minimal_readable_wrapper`.
    @return str Return value generated by `minimal_readable_wrapper`.
    """
    return f"""<!doctype html>
<html lang="it">
<head>
...
class BaseDownloader:
    """
    @brief Class `BaseDownloader` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    name: str = "base"
    ...
    def __init__(
        ...
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `__init__`.
        @param from_url Input parameter for `__init__`.
        @param out_dir Input parameter for `__init__`.
        @param session Input parameter for `__init__`.
        @param logger Input parameter for `__init__`.
        @param limit Input parameter for `__init__`.
        @param toc_only Input parameter for `__init__`.
        @param disable_numbering Input parameter for `__init__`.
        @return Any Return value generated by `__init__`.
        """
    ...
    def matches_url(cls, url: str) -> bool:
        """
        @brief Execute method `matches_url`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param cls Input parameter for `matches_url`.
        @param url Input parameter for `matches_url`.
        @return bool Return value generated by `matches_url`.
        """
        return False
    ...
    def probe_html(cls, url: str, html: str) -> bool:
        """
        @brief Execute method `probe_html`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param cls Input parameter for `probe_html`.
        @param url Input parameter for `probe_html`.
        @param html Input parameter for `probe_html`.
        @return bool Return value generated by `probe_html`.
        """
        return False

    def run(self) -> None:
        """
        @brief Execute method `run`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `run`.
        @return None Return value generated by `run`.
        """
        raise NotImplementedError

    def _toc_tree_from_html(self, toc_html: str) -> List[TocNode]:
        """
        @brief Execute method `_toc_tree_from_html`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_toc_tree_from_html`.
        @param toc_html Input parameter for `_toc_tree_from_html`.
        @return List[TocNode] Return value generated by `_toc_tree_from_html`.
        """
        return toc_from_nav_html(toc_html, self.from_url)

    def post_process(self) -> None:
        """
        @brief Execute method `post_process`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `post_process`.
        @return None Return value generated by `post_process`.
        """
    ...
    def _verify_toc_consistency(self) -> None:
        """
        @brief Execute method `_verify_toc_consistency`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_verify_toc_consistency`.
        @return None Return value generated by `_verify_toc_consistency`.
        """
    ...
    def _verify_toc_depth(self) -> None:
        """
        @brief Execute method `_verify_toc_depth`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_verify_toc_depth`.
        @return None Return value generated by `_verify_toc_depth`.
        """
        toc_path = self.out_dir / "toc.html"
        ...
        def get_max_depth(ul, current_depth=0):
            """
            @brief Execute method `get_max_depth`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param ul Input parameter for `get_max_depth`.
            @param current_depth Input parameter for `get_max_depth`.
            @return Any Return value generated by `get_max_depth`.
            """
            if not ul:
    ...
    def _prune_toc_and_clean_headings(self) -> None:
        """
        @brief Execute method `_prune_toc_and_clean_headings`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_prune_toc_and_clean_headings`.
        @return None Return value generated by `_prune_toc_and_clean_headings`.
        """
        import re
        ...
        def href_fragment_id(href: str) -> str:
            """
            @brief Execute method `href_fragment_id`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param href Input parameter for `href_fragment_id`.
            @return str Return value generated by `href_fragment_id`.
            """
            href = (href or "").strip()
            if not href:
                return ""
        ...
        if toc_path.exists():
            ...
            if root_ul:
                ...
                def prune_ul(ul, depth):
                    """
                    @brief Execute method `prune_ul`.
                    @details Implements deterministic control flow as defined by module runtime semantics.
                    @param ul Input parameter for `prune_ul`.
                    @param depth Input parameter for `prune_ul`.
                    @return Any Return value generated by `prune_ul`.
                    """
    ...
    def _deduplicate_toc_entries(self) -> None:
        """
        @brief Execute method `_deduplicate_toc_entries`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_deduplicate_toc_entries`.
        @return None Return value generated by `_deduplicate_toc_entries`.
        """
        toc_path = self.out_dir / "toc.html"
        if not toc_path.exists():
            return
        ...
        def process_nodes(nodes: List[TocNode], seen: Set[str]) -> List[TocNode]:
            """
            @brief Execute method `process_nodes`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param nodes Input parameter for `process_nodes`.
            @param seen Input parameter for `process_nodes`.
            @return List[TocNode] Return value generated by `process_nodes`.
            """
            out: List[TocNode] = []
            for n in nodes:
    ...
    def _enforce_toc_headings(self) -> None:
        """
        @brief Execute method `_enforce_toc_headings`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_enforce_toc_headings`.
        @return None Return value generated by `_enforce_toc_headings`.
        """
        toc_path = self.out_dir / "toc.html"
        doc_path = self.out_dir / "document.html"
        if not toc_path.exists() or not doc_path.exists():
        ...
        def clamp_heading_level(depth: int) -> int:
            """
            @brief Execute method `clamp_heading_level`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param depth Input parameter for `clamp_heading_level`.
            @return int Return value generated by `clamp_heading_level`.
            """
            try:
                depth_i = int(depth)
            except Exception:
        ...
        def find_referenced_container_id(h) -> str:
            """
            @brief Execute method `find_referenced_container_id`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param h Input parameter for `find_referenced_container_id`.
            @return str Return value generated by `find_referenced_container_id`.
            """
            for parent in h.parents:
    ...
    def _test_toc_headings(self) -> None:
        """
        @brief Execute method `_test_toc_headings`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_test_toc_headings`.
        @return None Return value generated by `_test_toc_headings`.
        """
        toc_path = self.out_dir / "toc.html"
        doc_path = self.out_dir / "document.html"
        if not toc_path.exists() or not doc_path.exists():
        ...
        def summarize(items: List[str]) -> str:
            """
            @brief Execute method `summarize`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param items Input parameter for `summarize`.
            @return str Return value generated by `summarize`.
            """
            if not items:
                return ""
    ...
    def fix_heading_ref_position(self) -> None:
        """
        @brief Execute method `fix_heading_ref_position`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `fix_heading_ref_position`.
        @return None Return value generated by `fix_heading_ref_position`.
        """
    ...
    def fix_heading_numbering(self) -> None:
        """
        @brief Execute method `fix_heading_numbering`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `fix_heading_numbering`.
        @return None Return value generated by `fix_heading_numbering`.
        """
        ...
        def normalize_ws(text: str) -> str:
            """
            @brief Execute method `normalize_ws`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param text Input parameter for `normalize_ws`.
            @return str Return value generated by `normalize_ws`.
            """
            return " ".join((text or "").split())

        def strip_numbering_prefix(text: str) -> str:
            """
            @brief Execute method `strip_numbering_prefix`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param text Input parameter for `strip_numbering_prefix`.
            @return str Return value generated by `strip_numbering_prefix`.
            """
            return normalize_ws(numbering_prefix_re.sub("", normalize_ws(text)))

        def set_flat_text(tag, text: str) -> None:
            """
            @brief Execute method `set_flat_text`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param tag Input parameter for `set_flat_text`.
            @param text Input parameter for `set_flat_text`.
            @return None Return value generated by `set_flat_text`.
            """
            tag.clear()
    ...
    def _clean_document_style(self) -> None:
        """
        @brief Execute method `_clean_document_style`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_clean_document_style`.
        @return None Return value generated by `_clean_document_style`.
        """
        # Process document.html
        doc_path = self.out_dir / "document.html"
        if doc_path.exists():
    ...
    def _add_document_style(self) -> None:
        """
        @brief Execute method `_add_document_style`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_add_document_style`.
        @return None Return value generated by `_add_document_style`.
        """
        doc_path = self.out_dir / "document.html"
...
"""
    ...
    def _normalize_document_links(self) -> None:
        """
        @brief Execute method `_normalize_document_links`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_normalize_document_links`.
        @return None Return value generated by `_normalize_document_links`.
        """
        doc_path = self.out_dir / "document.html"
        if not doc_path.exists():
            return
    ...
    def _remove_unused_images(self) -> None:
        """
        @brief Execute method `_remove_unused_images`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_remove_unused_images`.
        @return None Return value generated by `_remove_unused_images`.
        """
    ...
    def _remove_unused_assets(self) -> None:
        """
        @brief Execute method `_remove_unused_assets`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_remove_unused_assets`.
        @return None Return value generated by `_remove_unused_assets`.
        """
        assets_dir = self.out_dir / "assets"
        if not assets_dir.exists() or not assets_dir.is_dir():
            return
    ...
    def _normalize_image_position(self) -> None:
        """
        @brief Execute method `_normalize_image_position`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_normalize_image_position`.
        @return None Return value generated by `_normalize_image_position`.
        """
        assets_dir = self.out_dir / "assets"
        if not assets_dir.exists() or not assets_dir.is_dir():
            return
    ...
    def _clean_assets_tree(self) -> None:
        """
        @brief Execute method `_clean_assets_tree`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_clean_assets_tree`.
        @return None Return value generated by `_clean_assets_tree`.
        """
        assets_dir = self.out_dir / "assets"
        if not assets_dir.exists() or not assets_dir.is_dir():
            return
    ...
    def _remove_empty_assets_root(self) -> None:
        """
        @brief Execute method `_remove_empty_assets_root`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_remove_empty_assets_root`.
        @return None Return value generated by `_remove_empty_assets_root`.
        """
        assets_dir = self.out_dir / "assets"
        if not assets_dir.exists() or not assets_dir.is_dir():
            return
...
class DownloaderRegistry:
    """
    @brief Class `DownloaderRegistry` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    def __init__(self):
        """
    ...
    def register(self, downloader_cls: type[BaseDownloader]) -> None:
        """
        @brief Execute method `register`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `register`.
        @param downloader_cls Input parameter for `register`.
        @return None Return value generated by `register`.
        """
        self._classes.append(downloader_cls)

    def detect(self, url: str, session: requests.Session) -> type[BaseDownloader]:
        """
        @brief Execute method `detect`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `detect`.
        @param url Input parameter for `detect`.
        @param session Input parameter for `detect`.
        @return type[BaseDownloader] Return value generated by `detect`.
        """
...
def guess_ext_from_content_type(ct: str) -> str:
    """
    @brief Execute function `guess_ext_from_content_type`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param ct Input parameter for `guess_ext_from_content_type`.
    @return str Return value generated by `guess_ext_from_content_type`.
    """
...
class NetworkImageRecorder:
    """
    @brief Class `NetworkImageRecorder` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    ...
    def attach(self, page):
        """
        @brief Execute method `attach`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `attach`.
        @param page Input parameter for `attach`.
        @return Any Return value generated by `attach`.
        """
        def on_response(resp):
            """
            @brief Execute method `on_response`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param resp Input parameter for `on_response`.
            @return Any Return value generated by `on_response`.
            """
            try:
                url = resp.url
...
class DocumentViewerDownloader(BaseDownloader):
    """
    @brief Class `DocumentViewerDownloader` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    ...
    def _pick_best_outerhtml(self, page, selectors: List[str]) -> Optional[str]:
        """
        @brief Execute method `_pick_best_outerhtml`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_pick_best_outerhtml`.
        @param page Input parameter for `_pick_best_outerhtml`.
        @param selectors Input parameter for `_pick_best_outerhtml`.
        @return Optional[str] Return value generated by `_pick_best_outerhtml`.
        """
        best = None
        best_score = -1
    ...
    def _expand_full_toc(
        ...
        """
        @brief Execute method `_expand_full_toc`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_expand_full_toc`.
        @param page Input parameter for `_expand_full_toc`.
        @param max_rounds Input parameter for `_expand_full_toc`.
        @param settle_ms Input parameter for `_expand_full_toc`.
        @return None Return value generated by `_expand_full_toc`.
        """
        selectors = [
    ...
    def _scroll_toc_container(
        ...
        """
        @brief Execute method `_scroll_toc_container`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_scroll_toc_container`.
        @param page Input parameter for `_scroll_toc_container`.
        @param step_px Input parameter for `_scroll_toc_container`.
        @param max_rounds Input parameter for `_scroll_toc_container`.
        @param settle_ms Input parameter for `_scroll_toc_container`.
        @return None Return value generated by `_scroll_toc_container`.
        """
    ...
    def _find_scroll_container(self, page):
        """
        @brief Execute method `_find_scroll_container`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_find_scroll_container`.
        @param page Input parameter for `_find_scroll_container`.
        @return Any Return value generated by `_find_scroll_container`.
        """
        best = None
        best_area = -1
    ...
    def _auto_scroll_element(
        ...
        """
        @brief Execute method `_auto_scroll_element`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_auto_scroll_element`.
        @param page Input parameter for `_auto_scroll_element`.
        @param element Input parameter for `_auto_scroll_element`.
        @param settle_ms Input parameter for `_auto_scroll_element`.
        @param step_px Input parameter for `_auto_scroll_element`.
        @param max_rounds Input parameter for `_auto_scroll_element`.
        @param stable_rounds Input parameter for `_auto_scroll_element`.
        @param label Input parameter for `_auto_scroll_element`.
        @return bool Return value generated by `_auto_scroll_element`.
        """
        try:
    ...
    def _auto_scroll(
        ...
        """
        @brief Execute method `_auto_scroll`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_auto_scroll`.
        @param page Input parameter for `_auto_scroll`.
        @param settle_ms Input parameter for `_auto_scroll`.
        @param step_px Input parameter for `_auto_scroll`.
        @param max_rounds Input parameter for `_auto_scroll`.
        @param stable_rounds Input parameter for `_auto_scroll`.
        @return None Return value generated by `_auto_scroll`.
        """
    ...
    def _collect_cards_from_container(
        ...
        """
        @brief Execute method `_collect_cards_from_container`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_collect_cards_from_container`.
        @param page Input parameter for `_collect_cards_from_container`.
        @param container Input parameter for `_collect_cards_from_container`.
        @param settle_ms Input parameter for `_collect_cards_from_container`.
        @param step_ratio Input parameter for `_collect_cards_from_container`.
        @param stable_rounds Input parameter for `_collect_cards_from_container`.
        @param max_rounds Input parameter for `_collect_cards_from_container`.
        @return Dict[str, str] Return value generated by `_collect_cards_from_container`.
        """
        cards: Dict[str, str] = {}
        last_height = -1
        last_scroll_top = -1
    ...
    def _best_card_for_fragment(
        ...
        """
        @brief Execute method `_best_card_for_fragment`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_best_card_for_fragment`.
        @param cards Input parameter for `_best_card_for_fragment`.
        @param fragment Input parameter for `_best_card_for_fragment`.
        @return Optional[Tuple[str, str]] Return value generated by `_best_card_for_fragment`.
        """
        ...
        def score_value(val: str) -> int:
            """
            @brief Execute method `score_value`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param val Input parameter for `score_value`.
            @return int Return value generated by `score_value`.
            """
            if not val:
                return 0
            v = unquote(val).lower()
    ...
    def _fragment_matches_url(self, fragment: str, data_url: str) -> bool:
        """
        @brief Execute method `_fragment_matches_url`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_fragment_matches_url`.
        @param fragment Input parameter for `_fragment_matches_url`.
        @param data_url Input parameter for `_fragment_matches_url`.
        @return bool Return value generated by `_fragment_matches_url`.
        """
    ...
    def _iter_nodes(nodes: List[TocNode]) -> Iterable[TocNode]:
        """
        @brief Execute method `_iter_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_iter_nodes`.
        @return Iterable[TocNode] Return value generated by `_iter_nodes`.
        """
        for n in nodes:
            yield n
    ...
    def _first_numeric_index(nodes: List[TocNode]) -> Optional[int]:
        """
        @brief Execute method `_first_numeric_index`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_first_numeric_index`.
        @return Optional[int] Return value generated by `_first_numeric_index`.
        """
    ...
    def _trim_toc_nodes(nodes: List[TocNode]) -> List[TocNode]:
        """
        @brief Execute method `_trim_toc_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_trim_toc_nodes`.
        @return List[TocNode] Return value generated by `_trim_toc_nodes`.
        """
        if not nodes:
            return []
    ...
    def _limit_toc_nodes(
        ...
        """
        @brief Execute method `_limit_toc_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_limit_toc_nodes`.
        @param max_entries Input parameter for `_limit_toc_nodes`.
        @return List[TocNode] Return value generated by `_limit_toc_nodes`.
        """
    ...
    def _limit_by_reading_order(
        ...
        """
        @brief Execute method `_limit_by_reading_order`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_limit_by_reading_order`.
        @param max_entries Input parameter for `_limit_by_reading_order`.
        @return List[TocNode] Return value generated by `_limit_by_reading_order`.
        """
        if not max_entries or max_entries <= 0:
            return nodes
    ...
    def _prune_toc_to_allowed(
        ...
        """
        @brief Execute method `_prune_toc_to_allowed`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_prune_toc_to_allowed`.
        @param allowed_ids Input parameter for `_prune_toc_to_allowed`.
        @return List[TocNode] Return value generated by `_prune_toc_to_allowed`.
        """
        pruned: List[TocNode] = []
        for n in nodes:
    ...
    def _first_toc_entry_title(nodes: List[TocNode]) -> Optional[str]:
        """
        @brief Execute method `_first_toc_entry_title`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_first_toc_entry_title`.
        @return Optional[str] Return value generated by `_first_toc_entry_title`.
        """
        for node in nodes:
    ...
    def _is_important_notice_label(title: Optional[str]) -> bool:
        """
        @brief Execute method `_is_important_notice_label`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param title Input parameter for `_is_important_notice_label`.
        @return bool Return value generated by `_is_important_notice_label`.
        """
    ...
    def _is_important_notice_section(section_html: str) -> bool:
        """
        @brief Execute method `_is_important_notice_section`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param section_html Input parameter for `_is_important_notice_section`.
        @return bool Return value generated by `_is_important_notice_section`.
        """
    ...
    def _select_section_nodes(nodes: List[TocNode]) -> List[TocNode]:
        """
        @brief Execute method `_select_section_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_select_section_nodes`.
        @return List[TocNode] Return value generated by `_select_section_nodes`.
        """
        flat = list(DocumentViewerDownloader._iter_nodes(nodes))
        if not flat:
            return []
    ...
    def _dedup_toc_nodes_by_href(self, nodes: List[TocNode]) -> List[TocNode]:
        """
        @brief Execute method `_dedup_toc_nodes_by_href`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_dedup_toc_nodes_by_href`.
        @param nodes Input parameter for `_dedup_toc_nodes_by_href`.
        @return List[TocNode] Return value generated by `_dedup_toc_nodes_by_href`.
        """

        def dedup_list(items: List[TocNode]) -> List[TocNode]:
            """
            @brief Execute method `dedup_list`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param items Input parameter for `dedup_list`.
            @return List[TocNode] Return value generated by `dedup_list`.
            """
    ...
    def _is_section_scrollable(self, page, viewport_multiplier: float = 2.0) -> bool:
        """
        @brief Execute method `_is_section_scrollable`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_is_section_scrollable`.
        @param page Input parameter for `_is_section_scrollable`.
        @param viewport_multiplier Input parameter for `_is_section_scrollable`.
        @return bool Return value generated by `_is_section_scrollable`.
        """
        try:
    ...
    def _remove_toc_elements(self, soup: BeautifulSoup) -> None:
        """
        @brief Execute method `_remove_toc_elements`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_remove_toc_elements`.
        @param soup Input parameter for `_remove_toc_elements`.
        @return None Return value generated by `_remove_toc_elements`.
        """
    ...
    def _convert_doxygen_definition_lists(self, soup: BeautifulSoup) -> None:
        """
        @brief Execute method `_convert_doxygen_definition_lists`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_convert_doxygen_definition_lists`.
        @param soup Input parameter for `_convert_doxygen_definition_lists`.
        @return None Return value generated by `_convert_doxygen_definition_lists`.
        """
        try:
    ...
    def _extract_fragment_only(
        ...
        """
        @brief Execute method `_extract_fragment_only`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_extract_fragment_only`.
        @param soup Input parameter for `_extract_fragment_only`.
        @param fragment Input parameter for `_extract_fragment_only`.
        @return BeautifulSoup Return value generated by `_extract_fragment_only`.
        """
        frag = unquote((fragment or "").lstrip("#").strip())
        if not frag:
            return soup
        ...
        def pick_best_section(elements):
            """
            @brief Execute method `pick_best_section`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param elements Input parameter for `pick_best_section`.
            @return Any Return value generated by `pick_best_section`.
            """
            best = None
            best_score = 0
            best_len = None
        ...
        def matches_fragment(el) -> bool:
            """
            @brief Execute method `matches_fragment`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param el Input parameter for `matches_fragment`.
            @return bool Return value generated by `matches_fragment`.
            """
            if not el:
                return False
            el_id = el.get("id")
    ...
    def _wait_for_fragment(self, page, fragment: str, timeout_ms: int = 8000) -> bool:
        """
        @brief Execute method `_wait_for_fragment`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_wait_for_fragment`.
        @param page Input parameter for `_wait_for_fragment`.
        @param fragment Input parameter for `_wait_for_fragment`.
    ...
    def _click_toc_link(self, page, fragment: str) -> bool:
        """
        @brief Execute method `_click_toc_link`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_click_toc_link`.
        @param page Input parameter for `_click_toc_link`.
        @param fragment Input parameter for `_click_toc_link`.
    ...
    def run(self) -> None:
        ...
        def make_anchor(raw_fragment: str, title: str, used: Set[str]) -> str:
            """
            @brief Execute method `make_anchor`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param raw_fragment Input parameter for `make_anchor`.
            @param title Input parameter for `make_anchor`.
            @param used Input parameter for `make_anchor`.
            @return str Return value generated by `make_anchor`.
            """
        ...
        def normalize_text(value: str) -> str:
            """
            @brief Execute method `normalize_text`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param value Input parameter for `normalize_text`.
            @return str Return value generated by `normalize_text`.
            """
        ...
        def strip_ti_disclaimer(section_html: str) -> str:
            """
            @brief Execute method `strip_ti_disclaimer`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param section_html Input parameter for `strip_ti_disclaimer`.
            @return str Return value generated by `strip_ti_disclaimer`.
            """
            soup = BeautifulSoup(section_html, "lxml")
...
class DoxygenExportDownloader(BaseDownloader):
    """
    @brief Class `DoxygenExportDownloader` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    name = "doxygen-export"
    ...
    def _scope(self) -> Tuple[str, str]:
        """
        @brief Execute method `_scope`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_scope`.
        @return Tuple[str, str] Return value generated by `_scope`.
        """
    ...
    def _fetch_soup(self, url: str) -> BeautifulSoup:
        """
        @brief Execute method `_fetch_soup`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_fetch_soup`.
        @param url Input parameter for `_fetch_soup`.
        @return BeautifulSoup Return value generated by `_fetch_soup`.
        """
    ...
    def _is_in_scope(self, url: str, host: str, scope_dir_url: str) -> bool:
        """
        @brief Execute method `_is_in_scope`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_is_in_scope`.
        @param url Input parameter for `_is_in_scope`.
        @param host Input parameter for `_is_in_scope`.
        @param scope_dir_url Input parameter for `_is_in_scope`.
        @return bool Return value generated by `_is_in_scope`.
        """
        if not is_http_url(url):
            return False
        u = urlparse(url)
    ...
    def _page_title(self, soup: BeautifulSoup) -> str:
        """
        @brief Execute method `_page_title`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_page_title`.
        @param soup Input parameter for `_page_title`.
        @return str Return value generated by `_page_title`.
        """
        t = soup.find("title")
    ...
    def _document_title(self, soup: BeautifulSoup) -> str:
        """
        @brief Execute method `_document_title`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_document_title`.
        @param soup Input parameter for `_document_title`.
        @return str Return value generated by `_document_title`.
        """
    ...
    def _extract_main(self, soup: BeautifulSoup) -> BeautifulSoup:
        """
        @brief Execute method `_extract_main`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_extract_main`.
        @param soup Input parameter for `_extract_main`.
        @return BeautifulSoup Return value generated by `_extract_main`.
        """
    ...
    def _links_to_html_pages(
        ...
        """
        @brief Execute method `_links_to_html_pages`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_links_to_html_pages`.
        @param soup Input parameter for `_links_to_html_pages`.
        @param page_url Input parameter for `_links_to_html_pages`.
        @param host Input parameter for `_links_to_html_pages`.
        @param scope_dir_url Input parameter for `_links_to_html_pages`.
        @return Set[str] Return value generated by `_links_to_html_pages`.
        """
        out: Set[str] = set()
        for a in soup.find_all("a"):
            href = (a.get("href") or "").strip()
    ...
    def _expand_nav_tree(self, page) -> None:
        ...
        """
        @brief Execute method `_expand_nav_tree`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_expand_nav_tree`.
        @param page Input parameter for `_expand_nav_tree`.
        @return None Return value generated by `_expand_nav_tree`.
        """
    ...
    def _expand_nav_tree_full(self, page) -> None:
        ...
        """
        @brief Execute method `_expand_nav_tree_full`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_expand_nav_tree_full`.
        @param page Input parameter for `_expand_nav_tree_full`.
        @return None Return value generated by `_expand_nav_tree_full`.
        """
        expanded_count = 0
    ...
    def _expand_nav_tree_limited(self, page, limit: int) -> None:
        """
        @brief Execute method `_expand_nav_tree_limited`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_expand_nav_tree_limited`.
        @param page Input parameter for `_expand_nav_tree_limited`.
        @param limit Input parameter for `_expand_nav_tree_limited`.
        @return None Return value generated by `_expand_nav_tree_limited`.
        """
        total_clicks = 0
    ...
    def _cleanup_nav_tree_styles(self, page) -> None:
        """
        @brief Execute method `_cleanup_nav_tree_styles`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_cleanup_nav_tree_styles`.
        @param page Input parameter for `_cleanup_nav_tree_styles`.
        @return None Return value generated by `_cleanup_nav_tree_styles`.
        """
        page.evaluate(
            """
            (() => {
    ...
    def _fetch_nav_tree_with_playwright(self) -> Tuple[str, str]:
        """
        @brief Execute method `_fetch_nav_tree_with_playwright`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_fetch_nav_tree_with_playwright`.
        @return Tuple[str, str] Return value generated by `_fetch_nav_tree_with_playwright`.
        """
        nav_html = ""
        nav_outline = ""
    ...
    def _nav_link_href(self, link, base_url: str) -> str:
        """
        @brief Execute method `_nav_link_href`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_nav_link_href`.
        @param link Input parameter for `_nav_link_href`.
        @param base_url Input parameter for `_nav_link_href`.
        @return str Return value generated by `_nav_link_href`.
        """
        if not link:
            return ""
    ...
    def _toc_nodes_from_nav_html(self, nav_html: str) -> List[TocNode]:
        """
        @brief Execute method `_toc_nodes_from_nav_html`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_toc_nodes_from_nav_html`.
        @param nav_html Input parameter for `_toc_nodes_from_nav_html`.
        @return List[TocNode] Return value generated by `_toc_nodes_from_nav_html`.
        """
        soup = BeautifulSoup(nav_html or "", "lxml")
        root_ul = soup.find("ul")
        if not root_ul:
        ...
        def parse_ul(ul) -> List[TocNode]:
            """
            @brief Execute method `parse_ul`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param ul Input parameter for `parse_ul`.
            @return List[TocNode] Return value generated by `parse_ul`.
            """
            items: List[TocNode] = []
            for li in ul.find_all("li", recursive=False):
    ...
    def _iter_toc_nodes(nodes: List[TocNode]) -> Iterable[TocNode]:
        """
        @brief Execute method `_iter_toc_nodes`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param nodes Input parameter for `_iter_toc_nodes`.
        @return Iterable[TocNode] Return value generated by `_iter_toc_nodes`.
        """
        for n in nodes:
            yield n
    ...
    def _select_main_container(self, soup: BeautifulSoup):
        """
        @brief Execute method `_select_main_container`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_select_main_container`.
        @param soup Input parameter for `_select_main_container`.
        @return Any Return value generated by `_select_main_container`.
        """
        if not soup:
            return None
        main = (
    ...
    def _find_fragment_anchor(self, main, fragment: str):
        """
        @brief Execute method `_find_fragment_anchor`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_find_fragment_anchor`.
        @param main Input parameter for `_find_fragment_anchor`.
        @param fragment Input parameter for `_find_fragment_anchor`.
        @return Any Return value generated by `_find_fragment_anchor`.
        """
    ...
    def _normalize_heading_text(value: str) -> str:
        """
        @brief Execute method `_normalize_heading_text`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param value Input parameter for `_normalize_heading_text`.
        @return str Return value generated by `_normalize_heading_text`.
        """
    ...
    def _strip_duplicate_section_title(
        ...
        """
        @brief Execute method `_strip_duplicate_section_title`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_strip_duplicate_section_title`.
        @param container Input parameter for `_strip_duplicate_section_title`.
        @param title Input parameter for `_strip_duplicate_section_title`.
        @param section_anchor Input parameter for `_strip_duplicate_section_title`.
        @return Optional[str] Return value generated by `_strip_duplicate_section_title`.
        """
    ...
    def _extract_section_html(
        ...
        """
        @brief Execute method `_extract_section_html`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_extract_section_html`.
        @param soup Input parameter for `_extract_section_html`.
        @param fragment Input parameter for `_extract_section_html`.
        @param next_fragment Input parameter for `_extract_section_html`.
        @return str Return value generated by `_extract_section_html`.
        """
        ...
        def direct_child(el):
            """
            @brief Execute method `direct_child`.
            @details Implements deterministic control flow as defined by module runtime semantics.
            @param el Input parameter for `direct_child`.
            @return Any Return value generated by `direct_child`.
            """
            cur = el
    ...
    def _build_toc(self, doc: BeautifulSoup) -> List[TocNode]:
        """
        @brief Execute method `_build_toc`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_build_toc`.
        @param doc Input parameter for `_build_toc`.
        @return List[TocNode] Return value generated by `_build_toc`.
        """
        nodes: List[TocNode] = []
...
class ResourceExplorerModule:
    """
    @brief Class `ResourceExplorerModule` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    name: str = "base"
    ...
    def select(
        ...
        """
        @brief Execute method `select`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `select`.
        @param url Input parameter for `select`.
        @param html Input parameter for `select`.
        @param soup Input parameter for `select`.
        @return Optional[Dict[str, str]] Return value generated by `select`.
        """
        return None
    ...
    def run(self, downloader: "ResourceExplorerDownloader", selection: Dict[str, str]) -> None:
        ...
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `run`.
        @param downloader Input parameter for `run`.
        @param selection Input parameter for `run`.
        @return None Return value generated by `run`.
        """
        raise NotImplementedError
...
class RMModuleDoxigen(ResourceExplorerModule):
    """
    @brief Class `RMModuleDoxigen` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
...
class ResourceExplorerDownloader(BaseDownloader):
    """
    @brief Class `ResourceExplorerDownloader` runtime component.
    @details Encapsulates behavior used by downloader orchestration and processing pipeline.
    """
    ...
    def _select_module(
        ...
        """
        @brief Execute method `_select_module`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_select_module`.
        @param html Input parameter for `_select_module`.
        @param soup Input parameter for `_select_module`.
        @return Optional[Tuple[ResourceExplorerModule, Dict[str, str]]] Return value generated by `_select_module`.
        """
    ...
    def _render_with_playwright(self) -> str:
        """
        @brief Execute method `_render_with_playwright`.
        @details Implements deterministic control flow as defined by module runtime semantics.
        @param self Input parameter for `_render_with_playwright`.
        @return str Return value generated by `_render_with_playwright`.
        """
        try:
            with sync_playwright() as p:
                browser = p.chromium.launch(headless=True)
...
def build_arg_parser() -> argparse.ArgumentParser:
    """
    @brief Execute function `build_arg_parser`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @return argparse.ArgumentParser Return value generated by `build_arg_parser`.
    """
...
def print_strict_help(program: str, version: str, parser: argparse.ArgumentParser) -> None:
    """
    @brief Execute function `print_strict_help`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @param program Input parameter for `print_strict_help`.
    @param version Input parameter for `print_strict_help`.
    @param parser Input parameter for `print_strict_help`.
    @return None Return value generated by `print_strict_help`.
    """
    # Header
...
def main() -> int:
    """
    @brief Execute function `main`.
    @details Implements deterministic control flow as defined by module runtime semantics.
    @return int Return value generated by `main`.
    """
    ap = build_arg_parser()
